...
import image_761e4bc41e4797f2b059530040412c971cf21459 from '../../assets/761e4bc41e4797f2b059530040412c971cf21459.png';
import image_14eda866ffb7e5990bcfba528d31bd88361f1865 from '../../assets/14eda866ffb7e5990bcfba528d31bd88361f1865.png';
import image_2d883cecdcc329911bfbfd3c7d859a7b23353581 from '../../assets/2d883cecdcc329911bfbfd3c7d859a7b23353581.png';
...
interface ExtraBlock {
    ...
    guardian: string;
    strategy: string;
    threats: { name: string; weakness: string; color: string; }[];
    personas: string[];
    accentColor: string;
}
...
export default function FloorsClient({ extraBlocks }: FloorsClientProps) {
      ...
      <div className="space-y-16">
        ...
        <div id="thebel" className="scroll-mt-24">
          <Card className="p-0 overflow-hidden border-0 shadow-xl">
            <div className="relative h-64 md:h-80 w-full group">
               <ImageWithFallback 
                src={image_761e4bc41e4797f2b059530040412c971cf21459.src}
                alt="Thebel Block"
        ...
        <div id="yabbashah" className="scroll-mt-24">
          <Card className="p-0 overflow-hidden border-0 shadow-xl">
            <div className="relative h-64 md:h-80 w-full group">
               <ImageWithFallback 
                src={image_2d883cecdcc329911bfbfd3c7d859a7b23353581.src}
                alt="Yabbashah Block"
                className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
               />
               <div className={`absolute inset-0 bg-gradient-to-t ${theme === 'dark' ? "from-[#0a1929] via-[#0a1929]/60" : "from-white via-white/60"} to-transparent`} />
              ...
              <div className={`p-6 md:p-10 grid md:grid-cols-3 gap-8 md:gap-12 border-t ${theme === 'dark' ? "border-[#1269cc]/20" : "border-gray-100"}`}>
                 ...
                 <div className="space-y-6">
                    ...
                    <div className="grid gap-4">
                      ...
                      <div>
                        <span className={`block text-xs uppercase mb-1 ${theme === 'dark' ? "text-gray-500" : "text-gray-400"}`}>Key Strategy</span>
                        <p className={`text-sm leading-relaxed ${theme === 'dark' ? "text-gray-300" : "text-gray-600"}`}>{block.strategy}</p>
                      </div>
                    </div>
                 </div>
