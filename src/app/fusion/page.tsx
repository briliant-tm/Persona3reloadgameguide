/**
 * ============================================================
 * RENDERING TECHNIQUE: HYBRID (SSG + API Integration)
 * TRACKER TAG: [SSG-005-FUSION]
 * INTERACTIVE: Client-Side Rendering (CSR) for search/filter
 * ============================================================
 *
 * This page uses Hybrid Rendering:
 * - Initial render: Static content (SSG via `force-static`)
 * - After hydration: Fetches API data via Zustand store
 * - Fallback: Uses PERSONAS static data if API unavailable
 *
 * Features:
 *   - API-driven persona list (dummyjson.com)
 ...
 * ============================================================
 */
'use client'; // Required: useState, useEffect, useMemo (client-side hooks)
...
import { LazyPersonaList } from "../../components/LazyPersonaCard";
